...
export default function ProductPage() {
    return (
        <div className="min-h-screen bg-black text-white selection:bg-raven-500/30 overflow-x-hidden font-sans">
...
function StatCard({ icon: Icon, title, value, desc }) {
    return (
        <div className="p-10 bg-black border border-white/5 rounded-[2.5rem] hover:border-white/20 transition-all text-center group">
            <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center mx-auto mb-8 group-hover:bg-raven-600 group-hover:text-white transition-all">
