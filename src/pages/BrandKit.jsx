        ...
        return (
            <div className="max-w-6xl mx-auto space-y-6 pb-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="h-80 rounded-3xl bg-white/5 animate-pulse lg:col-span-2" />
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="inline-flex items-center gap-3 rounded-2xl bg-primary px-6 py-3 text-xs font-extrabold uppercase tracking-widest text-white shadow-lg shadow-primary/20 transition-all hover:bg-primaryHover active:scale-95 disabled:opacity-50"
                    >
                                ...
                                <div key={category}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        {formats.map((format) => {
                                            ...
                                            return (
                                                <button key={format} onClick={() => toggleFormat(format)} className={`rounded-2xl border p-4 text-left transition-all active:scale-[0.98] ${selected ? 'border-primary bg-primary/15' : 'border-white/10 bg-white/5 hover:border-white/20'}`}>
