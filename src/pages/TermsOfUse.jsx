...
export default function TermsOfUse() {
 ...
 <p className="text-textMuted mb-8">Effective Date: April 27, 2024</p>

 <section className="space-y-6 text-textMuted">
 <p>
 Welcome to socialraven.cloud ("we","our","us"). These Terms of Use ("Terms") govern your access to and use of our website, services, and products (collectively, the"Services"). By accessing or using our Services, you agree to be bound by these Terms. If you do not agree to these Terms, do not use our Services.
 </p>
 ...
 <h2 className="text-2xl font-bold text-textMain mt-10 mb-4">1. Use of Services</h2>
 ...
 <h2 className="text-2xl font-bold text-textMain mt-10 mb-4">2. User Conduct</h2>
 ...
 <h2 className="text-2xl font-bold text-textMain mt-10 mb-4">3. Content</h2>
 ...
 <h2 className="text-2xl font-bold text-textMain mt-10 mb-4">4. Intellectual Property</h2>
 ...
 <h2 className="text-2xl font-bold text-textMain mt-10 mb-4">5. Termination</h2>
 ...
 <h2 className="text-2xl font-bold text-textMain mt-10 mb-4">6. Disclaimer of Warranties</h2>
 ...
 <h2 className="text-2xl font-bold text-textMain mt-10 mb-4">7. Limitation of Liability</h2>
 ...
 <h2 className="text-2xl font-bold text-textMain mt-10 mb-4">8. Governing Law</h2>
 ...
 <h2 className="text-2xl font-bold text-textMain mt-10 mb-4">9. Changes to Terms</h2>
 ...
 <h2 className="text-2xl font-bold text-textMain mt-10 mb-4">10. Contact Us</h2>
 <p>If you have any questions about these Terms, please contact us:</p>
 <p>
 Email: info@socialraven.cloud<br />
