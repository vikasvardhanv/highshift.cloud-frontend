        ...
        <div className="container mx-auto px-4 py-32 max-w-7xl">
                ...
                <div className="text-center mb-16 relative">
                    ...
                    <motion.div 
                        ...
                        className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs font-bold uppercase tracking-widest text-raven-400 mb-8"
                    >
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 relative z-10">
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-6">
                                <Link to="/docs" className="px-8 py-4 bg-white text-black font-bold rounded-2xl text-center hover:bg-white/5 transition-all shadow-xl">
                                    Start Building
                                </Link>
                        ...
                        <div className="bg-black/40 rounded-3xl p-8 border border-white/5 shadow-2xl backdrop-blur-xl">
                            <div className="flex items-center gap-2 mb-6 border-b border-white/10 pb-4">
                                ...
                                <span className="text-[10px] text-gray-500 font-mono ml-4 tracking-widest uppercase font-black italic">Social_Raven_Client.py</span>
                            </div>
...
function DevCard({ icon: Icon, iconColor, title, description, code, link, linkText }) {
    return (
        <div className="group bg-obsidian-950 border border-white/5 hover:border-white/10 rounded-3xl p-8 transition-all hover:translate-y-[-4px] backdrop-blur-md">
            ...
            <Link to={link} className="inline-flex items-center gap-2 text-sm font-bold text-white hover:text-raven-400 transition-all group/link">
