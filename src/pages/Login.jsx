            ...
            <div className="glass-card w-full max-w-md p-8 rounded-2xl relative z-10 animate-fade-in bg-white/95 border border-slate-200 shadow-2xl">
                ...
                <div className="flex p-1 bg-slate-100 rounded-xl mb-6">
                    <button
                        ...
                        className={`flex-1 py-2 text-sm font-medium rounded-lg transition-all ${isLogin ? 'bg-white text-slate-950 shadow-sm' : 'text-slate-500 hover:text-slate-950'}`}
                    >
                        Login
                    </button>
                    <button
                ...
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full py-3 px-4 bg-white text-slate-900 border border-slate-200 hover:bg-slate-50 rounded-xl font-bold transition-all flex items-center justify-center gap-3 shadow-sm"
                    >
                    ...
                    <form onSubmit={handleEmailSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white text-slate-950 placeholder:text-slate-500 outline-none focus:ring-2 focus:ring-raven-500/40 transition-all"
                            />
                            <input
                                type="password"
