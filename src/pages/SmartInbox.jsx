    ...
    return (
        <div className="mx-auto flex max-w-[1680px] flex-col gap-6 pb-10">
            <header className="flex flex-col gap-5 border-b border-white/10 pb-6 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.2em] text-gray-400">
            ...
            <div className="grid min-h-[720px] grid-cols-1 gap-6 xl:grid-cols-[320px_minmax(0,1fr)_360px]">
                <aside className="flex min-h-0 flex-col rounded-3xl border border-white/10 bg-white/[0.03] p-5">
                    <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-medium text-gray-500">Choose what feeds the shared queue</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-4 grid grid-cols-3 gap-2">
                        {NETWORKS.map((item) => (
                            <button
                                ...
                                className={`rounded-2xl border px-3 py-3 text-xs font-extrabold uppercase tracking-widest transition-all ${network === item ? 'border-primary bg-primary/20 text-white' : 'border-white/10 bg-white/5 text-gray-500 hover:border-white/20 hover:text-gray-300'}`}
                            >
                    ...
                    <label className="relative mt-4 block">
                        ...
                        <input
                            ...
                            className="w-full rounded-2xl border border-white/10 bg-black/20 py-3 pl-11 pr-4 text-sm font-semibold text-white outline-none placeholder:text-gray-400 focus:border-primary/60"
                        />
                    </label>
                ...
                <main className="flex min-h-0 flex-col overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03]">
                    <div className="flex flex-col gap-4 border-b border-white/10 px-6 py-5 md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-xs font-bold uppercase tracking-widest text-gray-400">
                            ...
                            <div>
                                ...
                                <div>
                                    <h3 className="text-sm font-extrabold text-white">Inbox behavior</h3>
                                        <p className="text-xs font-medium text-gray-500">Selected channel mix</p>
                                    </div>
                                </div>
                ...
                <aside className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
                    <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                        <MessageSquareMore className="h-5 w-5 text-gray-300" />
                        <div>
