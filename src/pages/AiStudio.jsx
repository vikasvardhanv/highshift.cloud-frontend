...
export default function AiStudio() {
 ...
 { id: 'Minimalist', label: 'Minimal', icon: Bot, color: 'text-textMuted', bg: 'bg-bgSurface/10 border-slate-500/20' }
 ];
 ...
 <div className="p-4 bg-bgSurfaceHighlight rounded-xl border border-borderColor flex items-center gap-3">
