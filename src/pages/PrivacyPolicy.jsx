    ...
    return (
        <div className="max-w-4xl mx-auto py-12 px-4 space-y-8">
            <div>
                ...
                <p className="text-gray-500">Effective Date: January 1, 2024</p>
            </div>

            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-200">1. Introduction</h2>
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-200">2. Information We Collect</h2>
                <p className="text-gray-400 leading-relaxed">
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-200">3. How We Use Your Information</h2>
                <p className="text-gray-400 leading-relaxed">
                    We use your data to:
                </p>
                <ul className="list-disc pl-5 space-y-2 text-gray-400">
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-200">4. Data Sharing and Disclosure</h2>
                <p className="text-gray-400 leading-relaxed">
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-200">5. Your Rights</h2>
                <p className="text-gray-400 leading-relaxed">
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-200">6. Contact Us</h2>
                <p className="text-gray-400 leading-relaxed">
