      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <DashboardCard 
            ...
            action={
              <button className="text-xs bg-white/5 hover:bg-white/10 text-white px-3 py-1.5 rounded-lg border border-white/5 transition-colors flex items-center gap-1">
        ...
        <div className="space-y-6">
          ...
          <DashboardCard title="Upcoming Posts & Queue" className="h-[400px]">
             <div className="space-y-3 overflow-y-auto pr-2">
                ...
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="p-3 rounded-xl bg-white/5 border border-white/5 flex gap-3 hover:bg-white/10 transition-colors cursor-pointer group">
