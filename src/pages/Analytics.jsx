...
const StatCard = ({ title, value, change, isPositive, icon: Icon }) => (
 ...
 <div className="text-3xl font-black text-textMain tracking-tighter">
 {value}
 </div>
...
export default function Analytics() {
 ...
 <button key={period} className={`px-4 py-1.5 rounded-xl text-[10px] font-bold uppercase transition-all ${period === '7D' ? 'bg-primary/20 text-primary border border-primary/20' : 'text-textMuted hover:text-textMuted'}`}>
 {period}
 </button>
 ))}
 </div>
