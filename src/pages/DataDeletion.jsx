export default function DataDeletion() {
 ...
 <div>
 <h1 className="text-3xl font-bold text-textMain mb-2">User Data Deletion</h1>
 <p className="text-textMuted">Instructions for removing your data from Social Raven</p>
 </div>
 ...
 <h3 className="text-xl font-semibold text-textMain mt-8">How to remove your data:</h3>
