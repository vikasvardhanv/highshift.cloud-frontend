...
export default function ApiKeys() {
 ...
 <h1 className="text-4xl font-bold text-textMain mb-2 tracking-tight">API Management</h1>
 ...
 <div>
 <label className="text-xs font-bold text-textMuted uppercase tracking-widest mb-2 block">Key Alias</label>
 <input
 type="text"
 value={newKeyName}
 ...
 className="p-2.5 hover:bg-white/10 rounded-lg transition-colors text-textMuted hover:text-textMain"
 >
 ...
 <p className="text-textMuted font-medium">Scanning network for keys...</p>
 </td>
 </tr>
 ) : keys.length === 0 ? (
 <tr>
 ...
 <span className="font-bold text-textMain">{key.name}</span>
 </div>
 </td>
 <td className="px-8 py-5 text-sm text-textMuted">
 ...
 className="p-2.5 text-textMuted hover:text-red-400 hover:bg-red-500/10 rounded-xl transition-all opacity-0 group-hover:opacity-100"
