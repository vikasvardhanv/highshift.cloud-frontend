                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    ...
                                    <input
                                        ...
                                        className="appearance-none block w-full pl-10 px-3 py-2 border border-white/10 dark:border-slate-600 rounded-lg shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-raven-500 focus:border-raven-500 sm:text-sm bg-white/5 text-white"
