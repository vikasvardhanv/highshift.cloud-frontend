...
export default function History() {
 ...
 <p className="text-[10px] font-bold text-textMuted uppercase tracking-widest">Retrieving Archive Logs...</p>
 </div>
 );
 ...
 <Search className="w-4 h-4 absolute left-4 top-1/2 -translate-y-1/2 text-textMuted group-focus-within:text-primary transition-colors" />
 <input
 type="text"
 ...
 <p className="text-sm text-textMuted max-w-xs font-medium">No transmission records match your current filter parameters.</p>
 </div>
 ) : (
 <>
 ...
 <div className="text-[13px] font-bold text-textMain line-clamp-2 leading-relaxed">
 {post.content}
 </div>
 </td>
 <td className="p-8">
 ...
 <div className="text-[12px] font-bold text-textMuted">
 {new Date(post.scheduled_time || post.created_at).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
 </div>
 <div className="text-[10px] font-medium text-textMuted uppercase tracking-widest">
