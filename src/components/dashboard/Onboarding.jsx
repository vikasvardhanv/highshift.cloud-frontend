...
export default function Onboarding({ onComplete }) {
 ...
 <div className="bg-bgSurface border border-borderColor rounded-2xl p-8 shadow-sm">
 ...
 <div className="mt-8 pt-6 border-t border-borderColor flex items-center justify-center text-xs text-textMuted">
...
function ConnectButton({ platform, icon: Icon, description, onClick }) {
 ...
 <button
 onClick={onClick}
 className="flex items-start gap-4 p-4 rounded-xl border border-borderColor hover:border-raven-500 dark:hover:border-raven-500 hover:shadow-md transition-all text-left group bg-bgColor hover:bg-white dark:hover:bg-bgColor"
 >
 <div className="p-2.5 bg-bgSurfaceHighlight rounded-lg shadow-sm group-hover:bg-raven-500/10 group-hover:bg-raven-900/20 group-hover:text-raven-400 transition-colors">
