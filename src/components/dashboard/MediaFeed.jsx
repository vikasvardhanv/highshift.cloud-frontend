...
export default function MediaFeed() {
 ...
 default: return <Globe className="w-4 h-4 text-textMuted" />;
 }
 };
 ...
 <p className="text-[10px] text-textMuted truncate ml-5.5">
 @{account.username}
 </p>
 </div>
 </div>
 ...
 <button className="text-textMuted hover:text-red-400 transition-colors">
 ...
 <div className="flex-1 bg-bgColor rounded-3xl overflow-hidden flex flex-col">
 ...
 <button className="p-2 bg-bgColor backdrop-blur-md rounded-full text-white/70 hover:text-textMain hover:bg-raven-600 transition-all">
 <Bookmark className="w-4 h-4" />
 </button>
 </div>
 <div className="absolute top-4 right-4 z-20">
 <button className="p-2 bg-bgColor backdrop-blur-md rounded-full text-white/70 hover:text-textMain transition-all">
 ...
 <p className="text-xs text-textMuted line-clamp-2 mb-3 leading-relaxed">
 ...
 <button className="bg-raven-600 hover:bg-raven-500 text-textMain px-3 py-1 rounded-md text-[10px] font-bold uppercase tracking-wide flex items-center gap-1.5 transition-colors">
