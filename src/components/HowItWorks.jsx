...
function ScheduleAnimation() {
 ...
 <span className="text-xs font-bold text-textMuted">10:00 AM</span>
 </motion.div>
 )}
 </AnimatePresence>
...
function AnalyticsAnimation() {
 ...
 {/* Analytics label */}
 <motion.div
 className="absolute bottom-0 left-1/2 -translate-x-1/2 bg-bgSurfaceHighlight bg-white/10 rounded-full px-3 py-1"
 animate={{ scale: [1, 1.05, 1] }}
 transition={{ repeat: Infinity, duration: 2 }}
 >
 <div className="flex items-center gap-1">
 <BarChart2 className="w-3 h-3 text-primary" />
 <span className="text-xs font-bold text-textMuted">+27%</span>
 </div>
 </motion.div>
 </div>
 );
...
export default function HowItWorks() {
 ...
 return (
 <section className="py-24 bg-bgColor dark:bg-surface/30 relative overflow-hidden">
 ...
 >
 <h2 className="text-4xl md:text-5xl font-bold text-textMain mb-4">How It Works</h2>
 <p className="text-lg text-textMuted text-textMuted max-w-2xl mx-auto">
 ...
 >
 {/* Step number */}
 <div className="absolute -top-4 -left-4 w-10 h-10 bg-primary text-textMain rounded-xl flex items-center justify-center font-bold text-lg shadow-lg shadow-primary/30 z-10">
 {step.id}
 </div>
 ...
 {/* Text */}
 <h3 className="text-xl font-bold text-textMain mb-3 text-center">
 {step.title}
 </h3>
 <p className="text-textMuted text-textMuted text-center text-sm leading-relaxed">
 {step.description}
 </p>
 </div>
 </motion.div>
