...
export default function VideoHero() {
 ...
 <h1 className="text-4xl md:text-8xl font-black text-textMain italic uppercase tracking-tighter mb-4 leading-none">
 ...
 <h2 className="text-6xl md:text-[10rem] font-black text-textMain uppercase tracking-tighter italic leading-[0.85] shadow-2xl">
 The Social<br/>Robot
 </h2>
 <div className="h-2 w-32 bg-raven-600 mx-auto" />
 <p className="text-2xl md:text-5xl text-textMuted font-light italic leading-tight">
 ...
 <h2 className="text-6xl md:text-9xl font-black text-textMain italic tracking-tighter uppercase mb-6 leading-none">Chaos<br/>Removed</h2>
