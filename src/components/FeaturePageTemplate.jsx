...
export default function FeaturePageTemplate({
 ...
 {/* HERO */}
 <div className="relative pt-32 pb-20 overflow-hidden bg-bgColor">
 {/* Animated Gradient */}
 <motion.div
 ...
 >
 <motion.span
 className="inline-block py-1 px-3 rounded-full bg-white/10 border border-white/20 text-textMain text-xs font-bold uppercase tracking-widest mb-6 backdrop-blur-sm"
 whileHover={{ scale: 1.05, borderColor:"rgba(255,255,255,0.4)" }}
 >
 Feature Spotlight
 </motion.span>
 <motion.h1
 className="text-5xl md:text-7xl font-bold text-textMain mb-6 tracking-tight max-w-4xl mx-auto leading-tight"
 ...
 whileTap={{ scale: 0.98 }}
 >
 <Link to={finalCtaLink} className="px-8 py-4 bg-primary hover:bg-primaryHover text-textMain font-bold rounded-xl text-lg transition-all shadow-xl shadow-primary/10 flex items-center gap-2 relative overflow-hidden group">
 {/* Shimmer effect */}
 ...
 className="group relative p-8 rounded-3xl bg-bgColor border border-borderColor hover:border-primary/30 transition-all hover:shadow-2xl hover:bg-white dark:hover:bg-bgColor overflow-hidden"
 >
 ...
 {feature.animation && (
 <div className="h-48 bg-bgSurfaceHighlight dark:bg-black/20 rounded-t-2xl -m-8 mb-6 overflow-hidden relative">
 ...
 <h3 className="text-xl font-bold text-textMain group-hover:text-primary dark:group-hover:text-primary transition-colors">
 {feature.title}
 </h3>
 </div>
 <p className="text-textMuted text-textMuted leading-relaxed text-sm">
 {feature.description}
 </p>
 </div>
 ...
 {/* CTA */}
 <div className="py-24 bg-bgColor border-t border-borderColor relative overflow-hidden">
 ...
 >
 <motion.h2
 className="text-3xl md:text-4xl font-bold text-textMain mb-6"
 initial={{ opacity: 0, y: 20 }}
 ...
 <motion.p
 className="text-textMuted text-lg mb-8 max-w-xl mx-auto"
 initial={{ opacity: 0 }}
 ...
 whileTap={{ scale: 0.98 }}
 >
 <Link to={loginUrl} className="inline-flex items-center gap-2 px-10 py-4 bg-bgColor dark:bg-bgSurface text-textMain font-bold rounded-xl hover:opacity-90 transition-all shadow-xl hover:shadow-2xl relative overflow-hidden group">
