...
function LandingLayout({ children }) {
 return (
 <div className="min-h-screen bg-bgColor text-textMain selection:bg-raven-500/30 font-sans flex flex-col">
 <Navbar />
...
function App() {
 ...
 <Route path="/listening" element={<DashboardLayout><div className="p-10 text-center text-textMuted">Social Listening Feature Coming Soon</div></DashboardLayout>} />
 <Route path="/ads" element={<DashboardLayout><div className="p-10 text-center text-textMuted">Social Ads Feature Coming Soon</div></DashboardLayout>} />
